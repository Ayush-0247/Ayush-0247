...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Ayush%20Raj&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Software%20Engineer%20%7C%20Full%20Stack%20Developer&descAlignY=51&descAlign=50" width="100%"/>
...
> *"Driving product decisions, feature planning, and the technical roadmap."*

I'm a **Full Stack Developer** and **Founder & CTO** of **CipherVest Capital** — a finance and crypto intelligence platform. I love building scalable systems, real-time applications, and ephemeral secure platforms.
...
- 🏗️ Architected core system including backend APIs, database schema, and frontend using the **MERN stack**
- 📐 Driving product decisions, feature planning, and technical roadmap as the founding technical lead
...
- 🚀 Worked on the main **Flinque Platform**, adding various UI components and new features

---

### 🏢 Lifelink — *IVF Clinic Management Software*
...
- 🔒 **Zero Persistent DB Storage:** Built for temporary, owner-controlled communication sessions with server-authoritative lifecycle destruction.
- 🔑 **Cryptographic Security:** Secured using cryptographic passkeys and hashed authentication (`bcryptjs`).
- ⚡ **Low-Latency Messaging:** Powered by WebSocket duplex channels (`Socket.IO 4.8`) for instant message delivery and session events.
- 📱 **QR Code Access:** Integrated QR code generation (`qrcode`) for instant secure connection pairing and mobile session joining.
- 🎨 **Modern & Fluid UI:** Interactive, smooth interface crafted with **React 19**, **Motion** animations, **Tailwind CSS v4**, and **Lucide Icons**.

---

### 🖥️ Real-Time Collaborative Code Editor
> *Multi-user code editor with live cursor tracking and instant sync.*

**Tech Stack:** `React.js` `Node.js` `Socket.io` `Express.js` `Tailwind CSS`

- 👥 Multiple users write and sync code simultaneously in **shared rooms**
- 🖱️ **Live cursor tracking**, syntax highlighting, and instant updates via **WebSockets**
- ⚡ Built for low-latency real-time collaboration
...
- 📡 Real-time dashboard to **track and send sensor data** without breaks
...
- 🧾 **CRUD operations**, RESTful APIs, and a fully responsive user interface
